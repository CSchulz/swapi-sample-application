...
export class PlanetListDataSource extends DataSource<PlanetListItem> {
  ...
  private characterApiService = inject(PlanetApiService);
   ...
   */
  public connect(): Observable<PlanetListItem[]> {
   ...
   */
  private getPagedData(data: PlanetListItem[]): PlanetListItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: PlanetListItem[]): PlanetListItem[] {
